    ...
    data: [
      {
        ...
        address: '123 Main St',
        store: { id: 1, name: 'Pizza Palace', logo: 'https://ui-avatars.com/api/?name=Pizza+Palace&background=ff6b6b&color=fff&size=128&rounded=true' },
        rating: 4.8,
      ...
      },
      {
        ...
        store: { id: 2, name: 'Burger House', logo: 'https://ui-avatars.com/api/?name=Burger+House&background=f59e0b&color=fff&size=128&rounded=true' },
        rating: 4.5,
      ...
      },
      {
        ...
        store: { id: 3, name: 'Sushi World', logo: 'https://ui-avatars.com/api/?name=Sushi+World&background=3b82f6&color=fff&size=128&rounded=true' },
        rating: 4.9,
      ...
      },
      {
        ...
        store: { id: 4, name: 'Cafe Latte', logo: 'https://ui-avatars.com/api/?name=Cafe+Latte&background=8b5cf6&color=fff&size=128&rounded=true' },
        rating: 4.6,
    ...
    data: [
      {
        ...
        store: { id: 5, name: 'Fresh Mart', logo: 'https://ui-avatars.com/api/?name=Fresh+Mart&background=10b981&color=fff&size=128&rounded=true' },
        rating: 4.7,
        delivery_time: '20-30 min',
        delivery_fee: 0,
      },
      {
        ...
        store: { id: 6, name: 'Gadget Zone', logo: 'https://ui-avatars.com/api/?name=Gadget+Zone&background=ef4444&color=fff&size=128&rounded=true' },
        rating: 4.4,
      ...
      },
      {
        ...
        store: { id: 7, name: 'Book Corner', logo: 'https://ui-avatars.com/api/?name=Book+Corner&background=6366f1&color=fff&size=128&rounded=true' },
        rating: 4.9,
